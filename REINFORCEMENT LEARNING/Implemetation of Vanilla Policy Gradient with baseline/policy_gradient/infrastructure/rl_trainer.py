...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.agent = agent_class(self.sess, self.env, self.params['agent_params']) #PG AGENT getting initialized
        ...
        tf.global_variables_initializer().run(session=self.sess) #creating variables for this session !!

    def run_training_loop(self, n_iter, collect_policy, eval_policy,
                        initial_expertdata=None, relabel_with_expert=False,
                        start_relabel_with_expert=1, expert_policy=None):
        """
        :param n_iter:  number of (dagger) iterations  "data collection+labelling"
        :param collect_policy:
        :param eval_policy:
        :param initial_expertdata: #no expert data provision no imitation learning
        :param relabel_with_expert:  "whether to perform dagger-no right here we are training for n_iteration"
        ...
        for itr in range(n_iter):
            ...
            training_returns = self.collect_training_trajectories(itr,
                                ...
                                self.params['batch_size']) #batch data is the steps , paths(observation,rewards,terminal state)
            ...
            self.agent.add_to_replay_buffer(paths) #adding  continous paths of some #trajectories
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        #NO EXPERT DATA FOR FIRST TIME DIRECT COLLERCTING PATHS FOR TRAINING , NO USE OF ITR , WE NEED BATCH_SIZE
        ...
        print("\nCollecting data to be used for training...,batch=",batch_size) #64 ?
