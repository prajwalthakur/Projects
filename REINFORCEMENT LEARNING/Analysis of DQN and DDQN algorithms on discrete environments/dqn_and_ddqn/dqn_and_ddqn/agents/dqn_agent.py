...
from dqn_and_ddqn.infrastructure.dqn_utils import MemoryOptimizedReplayBuffer, PiecewiseSchedule
from dqn_and_ddqn.policies.argmax_policy import ArgMaxPolicy
from dqn_and_ddqn.critics.dqn_critic import DQNCritic
...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        #at the time of initialization self.last_obs= env.reset()
