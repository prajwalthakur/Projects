...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        # each model in the ensemble is trained on a different random batch of size batch_size
        losses = []
        #ensemble learning  
        ...
        for i in range(self.ensemble_size):
            ...
            loss = model.update(observations, actions, next_observations, self.data_statistics) #uppdate the weights of model by supervised learning
            losses.append(loss)
