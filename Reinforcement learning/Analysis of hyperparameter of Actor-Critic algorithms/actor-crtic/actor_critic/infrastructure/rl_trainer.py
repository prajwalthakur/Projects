...
from actor_critic.infrastructure.utils import *
from actor_critic.infrastructure.tf_utils import create_tf_session
from actor_critic.infrastructure.logger import Logger

from actor_critic.agents.dqn_agent import DQNAgent
from actor_critic.infrastructure.dqn_utils import get_wrapper_by_name
import pdb
...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        :param collect_policy:rl_trainer.agent.actor
        :param eval_policy:rl_trainer.agent.actor
        :param initial_expertdata:none
        ...
        for itr in range(n_iter):
            ...
            #def add_to_replay_buffer(self, paths): for dqn_agent.py
                #pass
    ...
    def train_agent(self):
        ...
        #THESE ARE FETTING BATCH SIZE DATA FROM  DQN BUFFER:
        losses=[]
